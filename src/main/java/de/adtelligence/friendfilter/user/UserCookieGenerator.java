 ...
 */
package de.adtelligence.friendfilter.user;
...
/**
 * Utility class for managing the friendfilter user cookie that remembers the signed-in user.
 * @author Keith Donald
 */
final class UserCookieGenerator {
	...
	public UserCookieGenerator() {
		userCookieGenerator.setCookieName("friendfilter_user");
	}
